...
if(isset($_REQUEST['empsubmit'])){
 ...
 if(($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")){
  ...
  $msg = '<div class="alert alert-warning mr-5 ml-5 mt-2 text-center" role="alert"> * All Fileds Are Required</div>';
 } else {
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-success  mr-5 ml-5 mt-2 text-center" role="alert"> Added Successfully </div>';
   } else {
    // below msg display on form submit failed
    $msg = '<div class="alert alert-danger mr-5 ml-5 mt-2 text-center" role="alert"> Unable to Add </div>';
   }
 }
 }
?>
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn butn-colour" id="empsubmit" name="empsubmit">Submit</button>
