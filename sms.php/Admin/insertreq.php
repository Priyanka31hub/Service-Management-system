    ...
    if(($_REQUEST['r_name'] == "") || ($_REQUEST['r_email'] == "") || ($_REQUEST['r_password'] == "")){
     ...
     $msg = '<div class="alert alert-warning mr-5 ml-5 mt-2" role="alert"> * All Fileds Are Required </div>';
      ...
      if($conn->query($sql) == TRUE){
       ...
       $msg = '<div class="alert alert-success  mr-5 ml-5 mt-2" role="alert"> Added Successfully </div>';
      } else {
       // below msg display on form submit failed
       $msg = '<div class="alert alert-danger  mr-5 ml-5 mt-2" role="alert"> Unable to Add </div>';
      }
    }
    }
?>
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn butn-colour" id="reqsubmit" name="reqsubmit">Submit</button>
