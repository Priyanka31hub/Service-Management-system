...
<div class="jumbotron col-sm-6 mt-5  mx-3">
 ...
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM assignwork_tb WHERE request_id = {$_REQUEST['id']}"; // work.php wale pge se name=id h uski request id match hongi aur data  dislay honga.
 ...
 <div class="text-center">
  <form class='d-print-none d-inline mr-3'><input class='btn butn-colour' type='submit'
   value='Print' onClick='window.print()'></form>  
  <form class='d-print-none d-inline' action="work.php"><input class='btn btn-secondary'
   type='submit' value='Close'></form>    <!--on clicking on close butn the form will redirect on work.php pge.-->
 </div>
</div>
