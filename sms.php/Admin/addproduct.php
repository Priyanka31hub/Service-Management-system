 ...
 if(($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") ||
  ...
  $psellingcost = $_REQUEST['psellingcost'];
   ...
   if($conn->query($sql) == TRUE){
    ...
    $msg = '<div class="alert alert-success text-center mr-5 ml-5 mt-2" role="alert"> Added Successfully </div>';
   } else {
    // below msg display on form submit failed
    $msg = '<div class="alert alert-danger text-center mr-5  ml-5 mt-2" role="alert"> Unable to Add </div>';
   }
 }
 }
?>
