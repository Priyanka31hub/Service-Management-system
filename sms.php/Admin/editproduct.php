 ...
 if(isset($_REQUEST['pupdate'])){
  ...
  $sql = "UPDATE assets_tb SET pname = '$pname', pdop = '$pdop', pava = '$pava', ptotal = '$ptotal', poriginalcost = '$poriginalcost', psellingcost = '$psellingcost' WHERE pid = '$pid'";
    if($conn->query($sql) == TRUE){
     ...
     $msg = '<div class="alert alert-success text-center mr-5 ml-5 mt-2" role="alert"> Updated Successfully </div>';
    } else {
     // below msg display on form submit failed
     $msg = '<div class="alert alert-danger text-center mr-5 ml-5 mt-2" role="alert"> Unable to Update </div>';
    }
  }
  }
 ?>
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="text-center">
      <button type="submit" class="btn butn-colour" id="pupdate" name="pupdate">Update</button>
