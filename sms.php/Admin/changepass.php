...
session_start();
 ...
 if(isset($_REQUEST['passupdate'])){
  if(($_REQUEST['aPassword'] == "")){
   ...
   $passmsg = '<div class="alert alert-warning  mt-2" role="alert"> *All Fields Are Required </div>';
  } else {
  ...
  <div class="row">
    <div class="col-sm-6">
      <form class="mt-5 mx-5">
        ...
        <button type="submit" class="btn butn-colour mr-4 mt-4" name="passupdate">Update</button>
